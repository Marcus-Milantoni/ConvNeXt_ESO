...
from ConvNeXt3D import custom_convnet_3s
import os
...
log_path = r"D:\Marcus\ESO_DL_DATA\DL_model_logs\ConvNeXt_3s"
model_save_path = r"D:\Marcus\ESO_DL_model\Model_saves\ConvNeXt_3s"
...
def main():
    ...
    model = custom_convnet_3s(num_classes=2, in_channels=2).to(device)
