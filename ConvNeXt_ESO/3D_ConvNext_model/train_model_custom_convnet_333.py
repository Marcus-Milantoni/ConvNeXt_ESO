...
log_path = r"D:\Marcus\ESO_DL_DATA\DL_model_logs\ConvNeXt_333"
model_save_path = r"D:\Marcus\ESO_DL_model\Model_saves\ConvNeXt_333"
...
def main():
    ...
    model = custom_convnet_333(num_classes=2, in_channels=2).to(device)
