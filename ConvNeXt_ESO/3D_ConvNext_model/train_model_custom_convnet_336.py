...
from ConvNeXt3D import custom_convnet_336
import os
...
log_path = r"D:\Marcus\ESO_DL_DATA\DL_model_logs\ConvNeXt_336"
model_save_path = r"D:\Marcus\ESO_DL_model\Model_saves\ConvNeXt_336"
...
def main():
    ...
    model = custom_convnet_336(num_classes=2, in_channels=2).to(device)
