...
log_path = r"D:\Marcus\ESO_DL_DATA\DL_model_logs\ConvNeXt_Tiny_CEL"
model_save_path = r"D:\Marcus\ESO_DL_model\Model_saves\ConvNeXt_Tiny_CEL"
...
def main():
    ...
    for epoch in tqdm(range(num_epochs), desc="Epochs", leave=False):
        ...
        if val_auc >= best_v_AUC:
            best_v_AUC = val_auc
            torch.save(model.state_dict(), os.path.join(model_save_path, f"best_val_auc_{epoch}.pth"))
