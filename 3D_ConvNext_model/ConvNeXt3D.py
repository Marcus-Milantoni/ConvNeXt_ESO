...
from torchvision.models._utils import _ovewrite_named_params
    ...
    def __init__(
        ...
        layers.append(
            Conv3dNormActivation(
                3, # Input channels for the model
...
def _convnext(
    ...
    if weights is not None:
        _ovewrite_named_params(kwargs, "num_classes", len(weights.meta["categories"]))
